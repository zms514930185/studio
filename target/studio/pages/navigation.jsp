...
<form action="${pageContext.request.contextPath}/studio/backstage/navigation" method="get">
...
<form action="${pageContext.request.contextPath}/studio/backstage/navigation" method="post">
    名称：<input type="text" name="name" style="width:70px">
    <%--状态：<input type="text" name="status" style="width:100px">--%>
    <%--序号：<input type="text" name="id" style="width:50px">
    创建时间：<input type="text" name="createAt" style="width:100px">
...
<table border="1" cellspacing="0" cellpadding="3">
    ...
    <c:forEach items="${selectNavigation}" var="navigation">
        <tr>
            ...
            <td>
                <a href="/studio/backstage/navigation/${navigation.id}">二级导航</a>
                <%--<form href="${pageContext.request.contextPath}/studio/navigation/${navigation.id}/">
                    <input type="submit" value="二级导航">
                </form>--%>
            </td>
            <td>
                <form action="${pageContext.request.contextPath}/studio/backstage/navigation" method="post">
...
<p>json-taglib</p>>
<json:object>
    <%--@elvariable id="selectNavigationAll" type="java.util.List"--%>
    <json:array name="Navigation" var="navigation" items="${selectNavigationAll}">
        <json:object>
            <json:property name="id" value="${navigation.id}"/>
            <json:property name="grade" value="${navigation.grade}"/>
            <json:property name="father" value="${navigation.father}"/>
            <json:property name="name" value="${navigation.name}"/>
            <json:property name="status" value="${navigation.status}"/>
            <json:property name="createBy" value="${navigation.createBy}"/>
            <json:property name="updateBy" value="${navigation.updateBy}"/>
            <json:property name="createAt" value="${navigation.createAt}"/>
            <json:property name="updateAt" value="${navigation.updateAt}"/>
        </json:object>
    </json:array>
</json:object>
</body>
